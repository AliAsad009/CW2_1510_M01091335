...
def load_csv_data():
    ...
    try:
        ...
        # Load users.csv directly into the users table
    ...
    try:
        ...
        # Load IT tickets data into the it_tickets table
    ...
    try:
        ...
        # Load datasets metadata into the datasets_metadata table
...
def test_crud():
    ...
    # Test incidents
    # Insert a sample incident and print the new ID
...
def main():
    ...
    # Step 2: Load initial data from CSV files
    ...
    # Step 4: Test CRUD operations for all tables
    print("\n[4/6] Testing CRUD operations...")
    test_crud()
    
    # Step 5: Query and display all data
    print("\n[5/6] Querying data...")
    query_data()
